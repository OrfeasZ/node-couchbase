...
MemcacheManager.prototype.Get = function(p_Identifier, p_Callback)
{
    ...
    this.MemcacheClients[p_Identifier].Client.Connect(function(p_Client)
    {
        s_Returned = true;
        s_Self.MemcacheClients[p_Identifier].Client = p_Client;
        ...
        p_Client.once('error', function() { s_Self.Remove(p_Identifier); });
    });
