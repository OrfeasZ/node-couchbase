 ...
 * @param p_Callback
 */
MemcacheClient.prototype.Connect = function(p_Callback)
{
    var s_Self = this;
    ...
    this.Socket.connect(this.Port, this.Host, function()
    {
        ...
        s_Self.GetSASLMechanisms(p_Callback);
        s_Self.DoPing();
    });
...
MemcacheClient.prototype.GetSASLMechanisms = function(p_Callback)
{
    var s_Self = this;
    ...
    this.SendRequest(0x20, {}, function(p_Error, p_Data)
    {
        ...
        {
            s_Self.PerformPlainSASLAuth(p_Callback);
            return;
        }
...
MemcacheClient.prototype.PerformPlainSASLAuth = function(p_Callback)
{
    var s_Self = this;
