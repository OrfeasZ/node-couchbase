...
CouchbaseClient.prototype.OnStreamConnectionClosed = function()
{
    // TODO: Reconnect to the stream
};
...
CouchbaseClient.prototype.InitConnection = function()
{
    ...
    //console.log('http://' + this.Bucket + ':' + this.Password + '@' + this.Hosts[0] + '/pools/default/bucketsStreaming/' + this.Bucket);

    // Right now we're using the first host
    // TODO: Get the last working/non-checked host
    this.StreamClient = http.get('http://' + this.Bucket + ':' + this.Password + '@' + this.Hosts[0] + '/pools/default/bucketsStreaming/' + this.Bucket, function(p_Response)
    {
